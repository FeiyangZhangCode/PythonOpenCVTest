    ...
    while cap.isOpened() and loop_num < 5:
        ...
        for min_value in range(20, 220, 20):
            for max_value in range(50, 450, 50):
                ...
                cv2.imwrite('./TestData/Cali-C-' + str_Time + '.jpg', rgb_frame)
                cv2.imwrite('./TestData/Cali-D-' + str_Time + '.jpg', rgb_rot)
        ...
        if x > 0:
            xls.save('./TestData/Cali-' + str_Time + '.xls')
            minCan = temp_minCan
            maxCan = temp_maxCan
...
def multi_calc(q_s0, q_s1, q_f, q_b, q_lf, q_rf, q_lb, q_rb, q_i, file_address):
    ...
    while True:
        ...
        if is_c0 or is_c1:
            ...
            cv2.rectangle(rgb_show_line, (half_width - 1, half_height - 1), (half_width + 1, half_height + 1), (0, 255, 0), 1)
